...
class LlavaMetaForCausalLM(ABC):
    ...
    def encode_images(self, images):
        ...
        if region_features is not None and hasattr(self.get_model(), "region_mm_projector"):
            # print("using region features")
    ...
    def prepare_inputs_labels_for_multimodal(
        ...
        for batch_idx, cur_input_ids in enumerate(input_ids):
            ...
            # print(cur_new_input_embeds, "new_embeds")
        ...
        if _position_ids is None:
            position_ids = None
        # print("new labels", new_labels, new_labels.size())
        # # Only keep input_ids where labels are not masked
        # target_token_indices = (new_labels != IGNORE_INDEX).nonzero(as_tuple=True)
        # print(target_token_indices, "target token indices.", target_token_indices.size())
        # target_input_ids = input_ids[target_token_indices]
