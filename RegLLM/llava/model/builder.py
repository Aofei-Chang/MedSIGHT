...
def load_pretrained_model(model_path, model_base, model_name, load_8bit=False, load_4bit=False, device_map="auto", device="cuda", use_flash_attn=False, overwrite_config=None, **kwargs):
        ...
        if 'lora' in model_name.lower() and model_base is not None:
            ...
            if 'mpt' in model_name.lower():
                ...
                if "qwen2" in model_name.lower() or "llava_qwen2" in model_name.lower():
                    ...
                    from llava.model.language_model.llava_qwen3 import LlavaQwenConfig
                    if overwrite_config is not None:
