...
export SFT_OUT_PATH=/qumulo/shared_data/aofei_summer/intern_records/LVLM/checkpoints/1105_full_instruct_71k_nosep
...
deepspeed llava/train/train_mem.py \
    ...
    --pretrained_llm_path /qumulo/shared_data/aofei_summer/intern_records/LVLM/checkpoints/reg_seg_align1105 \
