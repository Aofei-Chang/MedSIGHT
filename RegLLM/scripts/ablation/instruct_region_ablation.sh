...
export SFT_OUT_PATH=/qumulo/shared_data/aofei_summer/intern_records/LVLM/checkpoints/1107_ablation_71k_seg_token
...
deepspeed llava/train/train_mem.py \
    ...
    --data_path /qumulo/shared_data/aofei_summer/data/RegAlign/final_data/Instruct_71k_1104_seg_replaced.json \
