...
export SFT_OUT_PATH=/qumulo/shared_data/aofei_summer/intern_records/LVLM/checkpoints/reg_seg_instruct_01
...
deepspeed  llava/train/train_mem.py \
    ...
    --pretrained_llm_path /qumulo/shared_data/aofei_summer/intern_records/LVLM/checkpoints/reg_seg_01 \
    --deepspeed ./scripts/zero3.json \
    --version qwen \
    --data_path /qumulo/shared_data/aofei_summer/data/RegAlign/instruction_tuning_17k.json \
