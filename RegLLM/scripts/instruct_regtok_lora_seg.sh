...
export SFT_OUT_PATH=/qumulo/shared_data/aofei_summer/intern_records/LVLM/checkpoints/1101_lora64_393k_epoch1
...
deepspeed  llava/train/train_mem.py \
    ...
    --pretrained_llm_path /qumulo/shared_data/aofei_summer/intern_records/LVLM/checkpoints/reg_seg_align1101 \
    --version qwen \
    --deepspeed ./scripts/zero2.json \
    --data_path /qumulo/shared_data/aofei_summer/data/RegAlign/All_mixture_393k.json \
