...
export SFT_OUT_PATH=/qumulo/shared_data/aofei_summer/intern_records/LVLM/checkpoints/reg_seg_align0326
...
--master_port 16668 \
    ...
    --pretrain_mm_mlp_adapter /qumulo/shared_data/aofei_summer/RegTok/RegLLM/checkpoints/i2t_pre_region_0326/mm_projector.bin \
    --version qwen \
