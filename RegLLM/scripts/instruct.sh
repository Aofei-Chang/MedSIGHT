...
export SFT_OUT_PATH=checkpoints/i2t_instruct_full
...
deepspeed llava/train/train_mem.py \
    ...
    --data_path /qumulo/shared_data/aofei_summer/data/LVLM/HuatuoGPT/Filter_PubMedVision_InstructionTuning_VQA.json \
