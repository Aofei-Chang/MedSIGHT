...
export SFT_OUT_PATH=/qumulo/shared_data/aofei_summer/intern_records/LVLM/checkpoints/reg_seg_83k_moe_lora32
...
--master_port 16668 \
    ...
    --version qwen \
    --data_path /qumulo/shared_data/aofei_summer/data/RegAlign/Mixture_tuning_83k.json \
