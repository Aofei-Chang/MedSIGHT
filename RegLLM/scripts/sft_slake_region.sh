...
export SFT_OUT_PATH=/qumulo/shared_data/aofei_summer/checkpoints/LVLM/sft_slake_region
...
deepspeed llava/train/train_mem.py \
    ...
    --pretrain_mm_mlp_adapter /qumulo/shared_data/aofei_summer/RegTok/RegLLM/checkpoints/i2t_pre_region2/checkpoint-10106/mm_projector.bin \
