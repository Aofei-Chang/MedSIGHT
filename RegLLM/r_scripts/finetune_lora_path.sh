...
export WANDB_API_KEY="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"

export CUDA_VISIBLE_DEVICES=3

export PRETRAIN_OUT_PATH=checkpoints/i2t_pre_region
export SFT_OUT_PATH=/data/aofei/output/MedSight/PathVQA/lora16_epoch3
...
--master_port 16670 \
 llava/train/train_mem.py \
    ...
    --version qwen \
    --data_path /data/aofei/hallucination/PathVQA/pvqa/train.json \
    --image_folder /data/aofei/hallucination/PathVQA/pvqa/images/train \
