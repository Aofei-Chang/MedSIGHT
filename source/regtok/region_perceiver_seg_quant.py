...
class RegionPerceiver(nn.Module):
    ...
    def __init__(self, dim=512, num_queries=16, num_stacks=1, num_stages=2, dim_head=64, heads=8, ff_mult=4, num_classes=None, do_quantize=False, 
        ...
        semantic_label_dim = 768
        self.semantic_proj = None
        if semantic_label_dim is not None:
            self.semantic_proj = nn.Linear(self.dim, semantic_label_dim)
    ...
    def forward(self, image_features, mask_labels=None, class_labels=None, modality_label=None, loss_type="dice_bce", mask=None, do_quantize=False, deep_supervision=False, eos_coef=0.1,
